            ...
            <table class="w-full table-auto">
                ...
                <tbody class="text-gray-600 text-sm">
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-left"><?= $mhs['nim']; ?></td>
                        <td class="py-3 px-6 text-left"><?= $mhs['jurusan']; ?></td>
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                              <a href="delete.php?id=<?= $mhs['id']; ?>" onclick="return confirm('Apakah Anda Yakin ingin Menghapus?')" 
                                class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110">
                                    ...
                                    <a href="delete.php?id=<?= $mhs['id']; ?>"  onclick="return confirm('Apakah Anda Yakin ingin Menghapus?')" 
                                        class="w-4 mr-2 transform hover:text-blue-500 hover:scale-110 inline-block">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
